...
//	 private  LocalDateTime checkOut = LocalDateTime.now();
	...
	public ReservDto(int room_info_id, boolean reservation_type, LocalDateTime checkIn, LocalDateTime checkOut) {
		super();
	...
	public String toString() {
		return "ReservDto [room_info_id=" + room_info_id + ", user_id=" + user_id + ", reservation_type="
