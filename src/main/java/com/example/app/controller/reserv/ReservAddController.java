...
//		LocalDateTime checkOutDateTime = LocalDateTime.parse(checkOut, formatter);
			...
			System.out.println(cIn.toString() + ", " + cOut.toString() + " 1 - controller"); // 1
...
//		
			...
			// 3
//			ReservDto reservDto = new ReservDto(Integer.parseInt(room_info_id), Boolean.parseBoolean(reservation_type),
//					cIn, cOut);
			ReservDto reservDto = new ReservDto(Integer.parseInt(room_info_id), Boolean.parseBoolean(reservation_type),
					cIn, cOut);

			System.out.println(reservDto + "2 - controller"); // 2
...
//		
	...
	private boolean isValid(String room_info_id, String user_id, String reservation_type, String checkIn,
			String checkOut) {
