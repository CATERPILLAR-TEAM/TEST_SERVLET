...
public class ReservAddController implements SubController {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) {
		...
		//3 
		ReservDto reservDto = new ReservDto(Integer.parseInt(room_info_id),Boolean.parseBoolean(reservation_type),LocalDateTime.parse(checkIn),LocalDateTime.parse(checkOut));
	...
	private boolean isValid(String room_info_id, String user_id, String reservation_type, String checkIn, String checkOut) {
